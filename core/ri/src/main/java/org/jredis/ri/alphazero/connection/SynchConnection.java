...
//	@Override
		...
		throws RedisException
	{
		...
		try {
			...
			logger.warn("serviceRequest() -- ProviderException: " + bug.getLocalizedMessage()); // was Log.bug
			...
			e.printStackTrace();
			logger.warn("serviceRequest() -- *unexpected* RuntimeException: " + e.getLocalizedMessage()); // was Log.bug
