...
public abstract class JRedisTestSuiteBase<T> extends ProviderTestBase<T>{
	...
	/**
	 * @param <FAULT> the expected {@link Throwable} (base) exception class.
	 * @param test that is expected to raise FAULT
	 * @param errtype the expected {@link Throwable} (base) exception class.
	 */
